      ...
      <div class="d-flex align-center w-100">
        ...
        <div class="d-flex align-center ms-auto">
          ...
          <div class="d-none d-lg-flex align-center gap-2">
            ...
            >
              <v-icon
                :icon="enablePipelineHooks ? 'mdi-hook' : 'mdi-hook-off'"
                class="me-1"
              ></v-icon>
              Pipeline Hooks
            </v-btn>
            ...
            <v-btn color="error" variant="outlined" @click="resetPipeline">
          ...
          <div class="d-flex d-lg-none">
            <v-menu>
              ...
              <v-list density="compact">
                <v-list-item
                  :prepend-icon="
                    enablePipelineHooks ? 'mdi-hook' : 'mdi-hook-off'
                  "
                  :title="`Pipeline Hooks ${
                    enablePipelineHooks ? '(On)' : '(Off)'
                  }`"
                  @click="togglePipelineHooks"
                ></v-list-item>
                <v-list-item
              ...
              <v-expansion-panel>
                ...
                <v-expansion-panel-text>
                  <v-alert type="info" variant="text" density="compact">
                    ...
                    Custom hooks compose with built-in hooks. All enabled hooks
                    ...
                    -
                    <code
                      >beforeStep: (stepName: string, input: any) => void</code
                    ><br />
                    -
                    <code
                      >afterStep: (stepName: string, output: any) => void</code
                    ><br />
                    <br />
                    <strong>Custom Hook Examples:</strong><br />
                    <em>Data Validation:</em><br />
                    <code
                      >(stepName, input) => { if (!input) throw new
                    ...
                    <code
                      >(stepName, output) => {
                      performance.mark(`${stepName}-end`); }</code
                    ><br />
                    <br />
                    <em>Debug Inspection:</em><br />
                    <code
                      >(stepName, output) => { if (stepName === 'map')
                      console.log('Mapped:', output); }</code
                    ><br />
                    <br />
                    <strong>Error Handling:</strong><br />
                    Errors in custom hooks are caught and logged as warnings,
                    but won't stop pipeline execution.
                  </v-alert>
                </v-expansion-panel-text>
              </v-expansion-panel>
            </v-expansion-panels>
        ...
        <v-expansion-panel>
          <v-expansion-panel-title class="pipeline-panel-title">
            <div class="d-flex align-center w-100">
              ...
              <div class="d-flex align-center">
                <v-chip color="blue" size="small" class="me-2" variant="flat"
                  >SOURCE</v-chip
                >
                <span class="text-subtitle-2">{{
                  getOperationDisplayName(sourceOperation.type)
                }}</span>
              </div>
          ...
          <v-expansion-panel-title class="pipeline-panel-title">
            <div class="d-flex align-center w-100">
              ...
              <div class="d-flex align-center">
                ...
                >
                <span class="text-subtitle-2">{{
                  getOperationDisplayName(step.type)
                }}</span>
              </div>
        ...
        <v-expansion-panel>
          <v-expansion-panel-title class="pipeline-panel-title">
            <div class="d-flex align-center w-100">
              <!-- Left side: Label and Operation Name -->
              <div class="d-flex align-center">
                <v-chip color="green" size="small" class="me-2" variant="flat"
                  >OUTPUT</v-chip
                >
                <span class="text-subtitle-2">{{
                  getOperationDisplayName(outputOperation.type)
                }}</span>
              </div>
              ...
              <div class="d-flex align-center ms-auto">
                ...
                <div class="d-none d-md-flex align-center gap-1">
                  <v-btn
                    ...
                    color="primary"
                    @click.stop="
                      addFunctionalStep('filter', functionalSteps.length)
                    "
                  ></v-btn>
                </div>
          ...
          <v-expansion-panel-text>
            <div class="panel-content">
              ...
              <!-- Output Configuration - UPDATED to use OutputConfig -->
              <OutputConfig
...
const changeStepType = (stepId, newType) => {
  ...
  if (step) {
    ...
    pipelineStore.updateFunctionalStep(stepId, {
      ...defaultOptions,
      type: newType,
    });
