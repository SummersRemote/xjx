 ...
 */
class JsonToXNodeConverterImpl implements Converter<JsonValue, XNode, { config: Configuration }> {
   ...
   * @param config Configuration
   */
  private processJsonValue(element: XNode, value: JsonValue, config: Configuration): void {
      ...
      switch (attributeStrategy) {
        case 'property':
          ...
          if (attrs && typeof attrs === 'object' && !Array.isArray(attrs)) {
            element.attributes = { ...attrs as JsonObject };
   ...
   * @param config Configuration
   */
  private processArrayValue(element: XNode, array: JsonArray, config: Configuration): void {
