 ...
 * 
 * Returns a DOM Document with a stringify method for serialization
 */
import { XJX } from "../../XJX";
  ...
  try {
    ...
    enhancedDoc.stringify = function(options?: {
      ...
      try {
        ...
        return handleError(err, "stringify DOM to XML", {
    ...
    // For backward compatibility and convenience, also implement toString
    // that calls stringify with default options
    enhancedDoc.toString = function() {
