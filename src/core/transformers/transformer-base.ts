...
import { 
   ...
   */
  export abstract class BaseValueTransformer extends BaseTransformer implements ValueTransformer {
    /**
     ...
     * @returns Transformed value
     */
    protected abstract transformValue(value: any, node: XNode, context: TransformContext): any;
  }
  
  /**
   * Base class for attribute transformers
   */
  export abstract class BaseAttributeTransformer extends BaseTransformer implements AttributeTransformer {
    /**
   ...
   */
  export abstract class BaseChildrenTransformer extends BaseTransformer implements ChildrenTransformer {
    /**
   ...
   */
  export abstract class BaseNodeTransformer extends BaseTransformer implements NodeTransformer {
    /**
     ...
     * @returns Transformed node
     */
    protected abstract transformNode(node: XNode, context: TransformContext): XNode;
  }